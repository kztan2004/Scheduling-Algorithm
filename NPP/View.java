...
public class View extends JFrame{    
    ...
    private NPP npp;
    private Color PRIMARY = new Color(249, 245, 231);
    private Color SECONDARY = new Color(248, 234, 216);

    public View(){
        addedProcess = new ArrayList<Process>();
        setTitle("Non-Preemptive Priority");
    ...
    private void displayInput(){
        ...
        JLabel title1 = new JLabel("Non-Preemptive",SwingConstants.RIGHT);
        JLabel title2 = new JLabel(" Priority",SwingConstants.LEFT);
