...
public class View extends JFrame{    
    ...
    private RR rr;
    private Color PRIMARY = new Color(246, 255, 222);
    private Color SECONDARY = new Color(227, 242, 193);
    ...
    private void displayInput(){
        ...
        panel.setLayout(new GridLayout(7, 2, 1, 9));

        JLabel title1 = new JLabel("Round",SwingConstants.RIGHT);
        JLabel title2 = new JLabel(" Robin",SwingConstants.LEFT);
        
        JLabel label0 = new JLabel("Quantum: ",SwingConstants.CENTER);
        ...
        submitButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(!(textField0.getText().trim().isEmpty()) && Integer.parseInt(textField0.getText()) > 0){
                    panel.setVisible(false);
                    table.setVisible(false);
                    init();
                    int quantum = Integer.parseInt(textField0.getText());
                    rr = new RR(addedProcess, quantum);
                    displayOutput();
                }
            }
        });
