...
public class View extends JFrame{    
    ...
    private PP pp;
    private Color PRIMARY = new Color(212, 246, 255);
    private Color SECONDARY = new Color(198, 231, 255);

    public View(){
        addedProcess = new ArrayList<Process>();
        setTitle("Preemptive Priority");
    ...
    private void displayInput(){
        ...
        JLabel title1 = new JLabel("Preemptive",SwingConstants.RIGHT);
